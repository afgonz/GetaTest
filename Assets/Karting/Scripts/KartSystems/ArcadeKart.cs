...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        public struct Stats
        {
            ...
            [Tooltip("Force applied when the player use the jump button.")]
            [Range(0, 1000)]
            public float JumpForce;

            [Tooltip("Change the player direction and sensibility for a moment.")]
            public float LoseControl;
            ...
            public static Stats operator +(Stats a, Stats b)
            {
                return new Stats
                {
                    ...
                    LoseControl         = a.LoseControl + b.LoseControl,
                };
            }
        }
        ...
        void FixedUpdate()
        {
            ...
            // apply jump force from platforms
            JumpVehicle();
            ...
            // gather inputs and apply control modifiers
            float accel = Input.y;
            float turn = LoseControl() ? Input.x * 10f - 5f : Input.x;
        ...
        void JumpVehicle()
        {
            if (finalStats.JumpForce > 0)
            {
                Rigidbody.AddForce(Vector3.up * finalStats.JumpForce, ForceMode.Force);
                finalStats.JumpForce = 0f;
            }
        }

        bool LoseControl()
        {
            return finalStats.LoseControl > 0;
        }
